...
export function calculateShipping(weight, country, orderTotal) {
  ...
  if(country==="US"){
    ...
    else if(weight<=5&&orderTotal<=50) return 10
    else if(weight>5&&orderTotal<=50) return 15
    else if(orderTotal>50) return 0
  }
  else{
    if(weight<=1&&orderTotal<=100) return 15
    else if(weight<=5&&orderTotal<=100) return 25
    else if(weight>5&&orderTotal<=100) return 40
